...
START_TEST(CV___FROM_FLOAT_TO_DECIMAL) {
    ...
    ck_assert_int_eq(test_value_1.bits[1], 0);  /* округляет до 4 знаков после запятой, а не до 6 */
    ck_assert_int_eq(test_value_1.bits[2], 0);
    ck_assert_int_eq(test_value_1.bits[3], 262144);  /* 393216 = 10^(-6) */  /* выдаёт 262144 = 10^(-4) */

    s21_from_float_to_decimal(-2147.123654, &test_value_2);
    ck_assert_int_eq(test_value_2.bits[0], 2147124);  /* выдаёт 2147124 */
    ck_assert_int_eq(test_value_2.bits[1], 0);  /* округляет до 3 знаков после запятой, а не до 6 */
    ck_assert_int_eq(test_value_2.bits[2], 0);
...
START_TEST(CV___FROM_DECIMAL_TO_FLOAT) {
    s21_decimal test_value_1 = {{0, 0, 0, 0}};
    s21_decimal test_value_2 = {{4123456, 0, 0, 393216}};  //  393216 = 10^(-6)  //  196608 = 10^(-3)
...
START_TEST(R___FLOOR) {
    ...
    s21_decimal test_value_4 = {{0, 0, 0, 0}};
    // s21_decimal test_value_5 = {{0, 0, 0, 0}};
    ...
    // s21_decimal result_dec_5 = {{0, 0, 0, 0}};
    float result_1 = 0.0;
    float result_2 = 0.0;
    float result_3 = 0.0;
    float result_4 = 0.0;
    ...
    // s21_from_float_to_decimal(3294967293.980202308, &test_value_5);
    // s21_floor(test_value_5, &result_dec_5);
    // s21_from_decimal_to_float(result_dec_5, &result_5);
    // ck_assert_float_eq(result_5, 3294967293);
}
END_TEST
